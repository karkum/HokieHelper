...
/**
* The DrivingDirections abtract class is used in parsing and gathering the 
...
* @version 2.1.12
*/    
public abstract class Maps_DrivingDirections
{
	public interface IDirectionsListener {
		 ...
		 */
		public abstract void onDirectionsAvailable (Maps_Route route, Mode mode);
	...
	public void setLocationPoints(GeoPoint startPoint, GeoPoint endPoint, Mode mode, IDirectionsListener listener){
	    this.mode = mode;
        this.listener = listener;
	...
	public void startDrivingOverride(){
	    if(this.startPoint != null){
	        startDrivingTo(this.startPoint, this.endPoint, this.mode, this.listener);
	    }
	}
	...
	protected void onDirectionsAvailable (Maps_Route route)
	{
		if (listener != null) {
