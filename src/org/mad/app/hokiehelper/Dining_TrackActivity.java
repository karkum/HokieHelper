...
public class Dining_TrackActivity extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		//Tidy up the array
		Dining_CalWrapper[] calArray = Dining_MainActivity.calValues;
		...
		info.setOnClickListener(new OnClickListener()
		{
			public void onClick(View v)
			{
				AlertDialog.Builder dlgAlert  = new AlertDialog.Builder(Dining_TrackActivity.this);
				...
				dlgAlert.setPositiveButton("Reset",	new DialogInterface.OnClickListener()
				{
					public void onClick(DialogInterface dialog, int which)
					{
						...
						{
							FileOutputStream fos = openFileOutput("track.txt", MODE_PRIVATE);
							for (int i = 0; i < Dining_MainActivity.calValues.length; i++)
							{
								Dining_MainActivity.calValues[i].setCal(-1);
								Dining_MainActivity.calValues[i].setCarbs(-1);
								Dining_MainActivity.calValues[i].setProtein(-1);
								Dining_MainActivity.calValues[i].setFat(-1);
								Dining_MainActivity.calValues[i].setDate(new Date(10000000));
								fos.write(Dining_MainActivity.calValues[i].toString().getBytes());
							}
							fos.close();
						}
						catch (FileNotFoundException e)
				...
				dlgAlert.setNeutralButton("My Diet", new DialogInterface.OnClickListener()
				{
					public void onClick(DialogInterface dialog, int which)
					{
						Intent i = new Intent(Dining_TrackActivity.this, Dining_FoodListActivity.class);
						startActivity(i);
					}
				});
