...
public class Dining_DiningHall_TurnerPlace_AtomicPizzeria extends Dining_DiningHall {

	public Dining_DiningHall_TurnerPlace_AtomicPizzeria() {
		super("Atomic Pizzeria\n(Turner Place)");
	}
	...
	public int getIconId() {
		...
		if (state == DiningHallState.CLOSED || state == DiningHallState.OPEN) {
			return R.drawable.logo_atomic_pizzeria;
		} else {
			return R.drawable.logo_atomic_pizzeria_ex;
		}
	}
