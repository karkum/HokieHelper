...
public class Dining_DiningHall_TurnerPlace_FireGrill extends Dining_DiningHall {

	public Dining_DiningHall_TurnerPlace_FireGrill() {
		super("1872 Fire Grill\n(Turner Place)");
	}
	...
	public int getIconId() {
		...
		if (state == DiningHallState.CLOSED || state == DiningHallState.OPEN) {
			return R.drawable.logo_fire_grill;
		} else {
			return R.drawable.logo_fire_grill_ex;
		}
	}
