...
public class Dining_DiningHall_ABPSquiresKiosk extends Dining_DiningHall {

	public Dining_DiningHall_ABPSquiresKiosk() {
		super("Au Bon Pain\n(Squires Kiosk)");
	}
	...
	public int getIconId() {
		...
		if (state == DiningHallState.CLOSED || state == DiningHallState.OPEN) {
			return R.drawable.logo_abp_kiosk;
		} else {
			return R.drawable.logo_abp_kiosk_ex;
		}
	}
